...
public interface BartenderRepository extends JpaRepository<Bartender, Long> {
	...
	@Query("update Bartender b set b.name=:name,b.surname=:surname,b.email=:email,b.password=:pass where b.id=:id")
	public void updateBartender(@Param("id") long id, @Param("name") String name, @Param("surname")
